    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/login","/api/auth/verify", "/api/currency","/api/extravisaprice","/api/visa-requests","/api/visa-followups/{eacode}", "/api/visa-followups/with-agent/{eacode}").permitAll() // Allow login without authentication
